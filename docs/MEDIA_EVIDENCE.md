...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | Unknown | EXIF/GPS and other image metadata removed; resized from a copy | Historical prototype photo; capture date unavailable. |
