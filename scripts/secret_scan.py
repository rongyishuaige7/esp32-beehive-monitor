#!/usr/bin/env python3
"""Fail on credentials, private-network material, generated state, or unreviewed binaries."""
...
TEXT_SUFFIXES = {
    ...
    '.properties', '.xcconfig', '.pbxproj', '.m', '.mm', '.swift', '.java', '.kt',
}
FORBIDDEN_SUFFIXES = {'.apk', '.aab', '.bin', '.elf', '.map', '.o', '.a', '.so', '.pem', '.key', '.p12', '.jks', '.zip', '.7z', '.tar', '.gz'}
...
ALLOWED_EXACT_LINES = {
    ('docs/SOURCE_PROVENANCE.md', '/home/rongyi/桌面/beehive-monitor'),
    ('docs/SOURCE_PROVENANCE.md', '/home/rongyi/桌面/Hardware Lab-公开仓库/esp32-beehive-monitor'),
}
ALLOWED_SUBSTRINGS = {'YOUR_WIFI_SSID', 'YOUR_WIFI_PASSWORD', '<REDACTED>', '[REDACTED]'}
